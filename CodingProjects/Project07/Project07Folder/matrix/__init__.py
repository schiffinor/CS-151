        ...
        for x in range(int(self.rows)):
            for y in range(int(self.columns + other.columns)):
                if y < self.columns:
                    ...
                    newMatrix.set(x, y, other.get(x, y-self.columns))
        return newMatrix
        ...
        for x in range(newMatrix.rows):
            for y in range(newMatrix.columns):
                if y < self.columns:
                    ...
                    newMatrix.set(x, y, self.get(x, y-self.columns))
        return newMatrix
        ...
        for x in range(newMatrix.rows):
            for y in range(newMatrix.columns):
                if x < self.rows:
                    ...
                    newMatrix.set(x, y, self.get(x-self.rows, y))
        return newMatrix
        ...
        for x in range(newMatrix.rows):
            for y in range(newMatrix.columns):
                if x < self.rows:
                    ...
                    newMatrix.set(x, y, other.get(x-self.rows, y))
        return newMatrix
